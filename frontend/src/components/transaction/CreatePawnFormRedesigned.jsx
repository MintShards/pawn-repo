...
const CreatePawnFormRedesigned = ({ onSuccess, onCancel }) => {
  ...
  const selectCustomer = useCallback((customer) => {
    ...
    setCustomerSearchTerm(customerService.getCustomerFullName(customer));
  ...
  const canProceedToNext = () => {
    switch (activeStep) {
      ...
      case 'loan':
        return formData.loan_amount && formData.monthly_interest_amount && !interestRateError;
      default:
        return true;
    }
  };
                            ...
                            >
                              <div className="grid grid-cols-12 gap-4 items-center">
                                ...
                                <div className="col-span-4">
                                  <p className="font-semibold text-base text-slate-900 dark:text-slate-100 uppercase">
                  ...
                  <CardHeader className="pb-4">
                    <CardTitle className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-blue-600 dark:text-blue-400 uppercase">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <Button
                  ...
                  className="bg-pawn-accent hover:bg-pawn-accent/90 text-white shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <Plus className="h-4 w-4 mr-2" />
                  Add Item
                  <span className="text-xs ml-2 opacity-80">({formData.items.length}/8)</span>
                </Button>
              </div>
              ...
              <Card className="bg-gradient-to-br from-pink-50/80 to-rose-50/80 dark:from-pink-950/50 dark:to-rose-950/50 border-pink-200/50 dark:border-pink-800/50 shadow-lg overflow-hidden">
                <CardHeader className="pb-1.5 border-b border-pink-200/50 dark:border-pink-700/50">
                  <CardTitle className="flex items-center gap-2">
                    <div className="w-7 h-7 bg-gradient-to-br from-pink-500 to-rose-600 rounded-xl flex items-center justify-center shadow-md">
                      <Package className="w-3.5 h-3.5 text-white" />
                    </div>
                    <div>
                      <div className="text-base font-bold text-pink-800 dark:text-pink-200">
                        Items List
                      </div>
                ...
                <CardContent className="p-0">
                  ...
                  <div className="bg-white/50 dark:bg-slate-800/50">
                    {/* Table Header */}
                    <div className="bg-pink-100/50 dark:bg-pink-900/30 px-3 py-1.5 border-b border-pink-200/50 dark:border-pink-700/50">
                      <div className="grid grid-cols-12 gap-3 text-xs font-medium text-pink-800 dark:text-pink-200">
                    ...
                    {/* Table Rows */}
                    <div className="divide-y divide-pink-200/30 dark:divide-pink-700/30" ref={itemsContainerRef}>
                      {formData.items.map((item, index) => (
                        <div
                          key={index}
                          ref={(el) => (itemRefs.current[index] = el)}
                          className="px-3 py-1.5 hover:bg-pink-50/30 dark:hover:bg-pink-900/20 transition-colors"
                        >
                          <div className="grid grid-cols-12 gap-3 items-center">
                            <div className="col-span-1">
                              <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-pink-100 to-rose-100 dark:from-pink-900/50 dark:to-rose-900/50 flex items-center justify-center">
                            ...
                            <div className="col-span-6">
                              {expandedItem === index ? (
                                <Input
                                  ...
                                  className="h-7 text-sm bg-white/70 dark:bg-slate-700/70 border-pink-200 dark:border-pink-700 focus:border-pink-500 dark:focus:border-pink-400"
                                  maxLength={50}
                                  autoFocus
                                />
                              ) : (
                  ...
                  <Card className="bg-gradient-to-br from-slate-50/80 to-blue-50/80 dark:from-slate-800/80 dark:to-blue-900/50 border-slate-200/50 dark:border-slate-700/50 shadow-md">
                    <CardHeader className="pb-3">
                      <CardTitle className="flex items-center gap-2 text-slate-700 dark:text-slate-300">
                        <Package className="h-4 w-4 text-pawn-accent" />
                        Items Summary
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <Input
                            ...
                            placeholder="0.00"
                            className={interestRateError
                              ? "pl-12 h-12 text-base bg-white/70 dark:bg-slate-800/70 border-red-500 focus:border-red-500"
                              : "pl-12 h-12 text-base bg-white/70 dark:bg-slate-800/70 border-cyan-200 dark:border-cyan-700 focus:border-cyan-500 dark:focus:border-cyan-400"
                            }
                          />
                        </div>
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <Card className="bg-gradient-to-br from-orange-50/80 to-red-50/80 dark:from-orange-950/50 dark:to-red-950/50 border-orange-200/50 dark:border-orange-800/50 shadow-md hover:shadow-lg transition-shadow">
                    ...
                    <CardContent className="space-y-2">
                      <div>
                        <p className="font-semibold text-lg text-slate-900 dark:text-slate-100 uppercase">
                  ...
                  <Card className="bg-gradient-to-br from-cyan-50/80 to-teal-50/80 dark:from-cyan-950/50 dark:to-teal-950/50 border-cyan-200/50 dark:border-cyan-800/50 shadow-md hover:shadow-lg transition-shadow">
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-pawn-dark dark:text-pawn-light">
                      ...
                      <CardTitle className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-lg font-bold text-rose-800 dark:text-rose-200">
                            Pawned Items ({formData.items.filter(i => i.description.trim()).length})
                          </div>
                        ...
                        <div className="divide-y divide-rose-200/30 dark:divide-rose-700/30">
                          {formData.items.filter(item => item.description.trim()).map((item, index) => (
                            <div key={index} className="px-4 py-4 hover:bg-rose-50/30 dark:hover:bg-rose-900/10 transition-colors">
                              <div className={`grid grid-cols-12 gap-4 ${item.serial_number ? 'items-start' : 'items-center'}`}>
              ...
              {formData.internal_notes && (
                <Card className="bg-slate-50/80 dark:bg-slate-800/80 border-slate-200/50 dark:border-slate-700/50">
                  <CardHeader className="pb-3">
                    <CardTitle className="text-sm flex items-center gap-2 text-pawn-dark dark:text-pawn-light">
                      <FileText className="h-3 w-3 text-blue-600 dark:text-blue-400" />
                      Internal Notes
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-sm text-pawn-dark dark:text-pawn-light italic">
                      {formData.internal_notes}
                    </p>
                  </CardContent>
                </Card>
            ...
            <div className="flex items-center gap-2">
              ...
              {activeStep !== 'review' ? (
                ...
                <Button
                  ...
                  disabled={submitting || !isFormValid || interestRateError}
